...
public class PriceService : IPriceService, IDisposable
{
    ...
    private readonly MarketData.Grpc.MarketDataService.MarketDataServiceClient _client;
    ...
    public PriceService(IOptions<GrpcSettings> grpcSettings, ILogger<PriceService> logger)
    {
        ...
        _client = new MarketData.Grpc.MarketDataService.MarketDataServiceClient(_channel);
    }
